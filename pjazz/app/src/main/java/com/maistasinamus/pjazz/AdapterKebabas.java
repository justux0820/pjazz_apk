...
public class AdapterKebabas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterKebabas(Context context, List<NewEntry> data) {
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.data = data;
        for (NewEntry kebab : data) {
            Log.e("kebab", kebab.getPavadinimas() + " " + kebab.getKaina());
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        myHolder.textDydis.setText("Gėrimai: " + current.getDydis());
        myHolder.textMesa.setText("Padažai: " + current.getMesa());
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyHolder(View itemView) {
            super(itemView);
            textPavadinimas = itemView.findViewById(R.id.textPavadinimas);
            textDydis = itemView.findViewById(R.id.textDydis);
            textMesa = itemView.findViewById(R.id.textMesa);
            textKaina = itemView.findViewById(R.id.textKaina);
