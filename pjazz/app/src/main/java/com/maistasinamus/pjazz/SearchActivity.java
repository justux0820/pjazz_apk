...
public class SearchActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerKebab;
    private AdapterKebabas mAdapter;
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder().appendQueryParameter("searchQuery", searchQuery)
                        .appendQueryParameter("veiksmas", "ieskoti");
            ...
            if(result.equals("\t[]no rows ")) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        NewEntry kebab = new NewEntry(
                                json_data.getInt("id"),
                                json_data.getString("pavadinimas"),
                                json_data.getString("dydis"),
                                json_data.getString("gerimas"),
                                json_data.getString("padazas"),
                    ...
                    recyclerKebab = findViewById(R.id.kebabList);
                    mAdapter = new AdapterKebabas(SearchActivity.this, data);
                    recyclerKebab.setAdapter(mAdapter);
                    recyclerKebab.setLayoutManager(new LinearLayoutManager(SearchActivity.this));
